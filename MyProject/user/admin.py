...
class myfeedbackAdmin(admin.ModelAdmin):
    list_display = ('name','email','message','picture',)
...
class collegeAdmin(admin.ModelAdmin):
    list_display = ('id','college_name','college_pic')
...
class placementAdmin(admin.ModelAdmin):
    list_display = ('id','student_picture','student_name','college','session','company_name','company_logo')
admin.site.register(placement,placementAdmin)

class signupAdmin(admin.ModelAdmin):
    list_display = ('name','email','passwd','mobile','profile','course','pyear','college','batch','batchid','status')
